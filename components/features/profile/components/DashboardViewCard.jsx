...
const MODE_OPTIONS = [
  { value: "live", label: "Live Clock", help: "Time In / Time Out buttons" },
  { value: "manual", label: "Manual Entry", help: "Input time manually" },
];
  ...
  return (
    <GlassCard padding="20px">
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          <div style={TITLE_STYLE}>DASHBOARD VIEW</div>
          <div style={SUBTITLE_STYLE}>
            Choose your preferred home dashboard style.
          </div>
        </div>
        ...
        {MODE_OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              aria-label={`Set dashboard view to ${option.label}`}
